...
const kmlFileUrl = () => {
    return window.location.host.includes('localhost')
      ? 'https://coviddev.gccservice.in/api/csr/hotspots' + '?dummy=' + new Date().getTime()
      : window.location.protocol + '//' + window.location.host + getHotZonesUrl + '?dummy=' + new Date().getTime();
};
